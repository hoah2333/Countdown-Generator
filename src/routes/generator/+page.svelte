...
<div id="component-wrapper">
	...
	{#if generated}
		<div class="generated">
			<hr />
			{#each [`[[iframe ${outputLink} style="width: 400px; height: 70px;"]]`, `由于条目的分数为-X分，现根据[[[deletions-policy|删除政策]]]，宣告将删除此页：\n[[iframe ${outputLink} style="width: 400px; height: 70px;"]]\n如果你不是作者又想要重写该条目，请在此帖回复申请。请先取得作者的同意，并将原文的源代码复制至沙盒里。除非你是工作人员，否则请勿就申请重写以外的范围回复此帖。`, `由于翻译质量不佳，宣告删除。\n[[iframe ${outputLink} style="width: 400px; height: 70px;"]]`] as outputs}
				<blockquote>
					<a
						href="/"
